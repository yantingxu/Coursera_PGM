...
switch testNum
  ...
  case 3
    [unused, logZ] = CliqueTreeCalibrate(sampleUncalibratedTree, false);
  ...
  case 4
    ...
    [nll, unused] = InstanceNegLogLikelihood(sampleX, sampleY, sampleTheta, sampleModelParams);
    assert(nll, sampleNLL, 1e-6);

  case 5
    [unused, grad] = InstanceNegLogLikelihood(sampleX, sampleY, sampleTheta, sampleModelParams);
